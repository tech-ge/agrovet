const Products = (() => {
  let state = { products: [], search: '', category: '', lowStock: false };
      ...
      <div class="toolbar">
        <div class="toolbar-left">
          <div class="input-wrap">
            ...
            <input type="search" id="searchInput" class="input" placeholder="Search by name or SKU" value="${App.escapeHtml(state.search)}" />
          </div>
    ...
    App.modal.show(`
      ...
      <form id="productForm" class="form-grid">
        ...
        <div class="form-group">
          <label>SKU</label>
          <input class="input" name="sku" value="${App.escapeHtml(p.sku || '')}" />
        </div>
        <div class="form-group">
